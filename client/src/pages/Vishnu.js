...
const Vishnu = ({ addLike1, addLike, auth }) => {
  ...
  return isLoading ? (
    ...
    <div>
      ...
      <div className="Temples">
        <h1 className="Temples-heading">Vishnu Temples</h1>
        <input
          className="Searchbar"
          placeholder="Search....."
          onChange={(event) => {
        ...
        {temples
          .filter((temple) => temple.deity === "Vishnu")
          .sort((a, b) => {
...
export default connect(mapStateToProps, { addLike, addLike1, loadUser })(
  Vishnu
);
